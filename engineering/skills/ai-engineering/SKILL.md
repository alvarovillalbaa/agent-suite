...
name: ai-engineering
description: >-
  Use for ML, data, and AI engineering work: data pipelines, ETL and ELT,
  DataOps, warehouses and lakehouses, streaming systems, prompt and agent
  design, RAG, constrained generation, experiment design, model evaluation,
  feature engineering, and computer vision systems from dataset prep through
