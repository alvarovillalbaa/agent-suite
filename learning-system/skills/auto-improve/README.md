...
- memory audits and cleanup passes
...
```bash
npx -y skills add ./learning-system/skills/auto-improve
mkdir -p ~/.codex/skills
cp -R learning-system/skills/auto-improve ~/.codex/skills/
```

Codex `$skill-installer` path:

```text
https://github.com/alvarovillalbaa/plugins/tree/main/learning-system/skills/auto-improve
```
