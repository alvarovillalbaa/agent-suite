...
name: finances
description: >-
  Use for finance work across accounting reconciliation, financial modeling, and
  fundraising materials. Covers statement-to-ledger reconciliation, receipt
  linking, cash flow and scenario models, cap tables, investor messaging,
  materials audits, and fundraising process diagnostics.
version: 1.0.0
license: MIT
