...
5. Route each selected target to the appropriate sub-flow below. Process multiple targets one at a time, highest leverage first.
...
Good mutations:
- Use the `code-documentation` contract consistently: Core docs (`README.md`, `ARCHITECTURE.md`, `TESTS.md`), Conditional docs (`SETUP.md`, `RUNBOOK.md`, `CHANGELOG.md`, `SECURITY.md`), Rare docs (`OVERVIEW.md`, `FAQ.md`, `DECISIONS.md`, `DEPENDENCIES.md`), root instruction docs, and `runbooks/`
